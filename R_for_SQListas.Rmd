...
```{r}
fit <- auto.arima(ts_1992, stepwise=FALSE, max.order = 10)
summary(fit)
res <- fit$residuals
acf(res, main='Autocorrelation of residuals')
plot(density(res))
